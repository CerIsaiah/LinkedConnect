...
Reverse-engineers Handshake's internal API and front-end architecture to run a high-throughput scraper, populating a NoSQL database with 10,000+ data points for job market trend analysis.

**Alumni career discovery**
Uses Google-indexed scraping to automate the discovery of alumni career paths, extracting and mapping LinkedIn profile data with an **89%+ user-to-alumni match rate**.
